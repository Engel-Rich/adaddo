...
function Login() {
  ...
  const Loader = () => (
    <>
      <Spin tip="Login process running..."></Spin>
    </>
  );
  return (
    <div
      className="container p-5 d-flex justify-content-center min-vh-100 align-items-center"
      style={{ font: "Exo,sans-serif" }}
    >
      <form>
        <div
          className="mb-3 mt-3 py-2 text-center d-flex justify-content-center align-items-center display-5"
...
function SignOut() {
  ...
  return (
    <div
      ...
      style={{ font: "Exo,sans-serif", width: "100%" }}
    >
      <form>
        <div
          className="mb-3 mt-3 py-2 text-center d-flex justify-content-center align-items-center display-5"
        ...
        <div
          className="text-danger mt-5 mb-3 "
          style={{ fontWeight: "bold", color: "GrayText" }}
        >
          {errorLogin}
        </div>
